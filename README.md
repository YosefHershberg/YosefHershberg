<h1 align="center">Hi 👋, I'm Yosef Hershberg</h1>
<h3 align="center">Full Stack Developer • React | Node.js | AI-Driven Enterprise Applications</h3>

<p align="center">
<em>Productivity, Consistency, and Creativity.</em><br/>
I architect scalable, AI-driven enterprise applications that translate complex business requirements into maintainable, production-ready solutions.
</p>

---

- 🏢 Currently working as a **Full Stack Developer at Proceed**, building enterprise-grade Project & Portfolio Management (PPM) applications on **Broadcom Clarity** for the Israeli market

- 🎓 **Lead Lecturer at Analiza Education Center** — training Haredi (חרדים) students and IDF technological units in **JavaScript, React, Node.js, SQL/NoSQL, Kubernetes**, OOP in **C#**, and software design patterns

- 🍳 Designed and built [**CulinaryGPT**](https://culinary-gpt.vercel.app/) — an AI-powered recipe generator using **React, Node.js, MongoDB**, deployed on **AWS ECS** with **Docker**. Reduced wait times by **40%** via parallelized API calls and **Server-Sent Events (SSE)**

- 💻 Also developed [**CodeSplainer**](https://code-explain-app.vercel.app/) and [**MessageSpace**](https://github.com/Ti-Space/message-space-app)
